        ...
        <Header style={styles.header}>
          ...
          <div style={styles.headerRight}>
            ...
            <TokenPrice
              ...
              chain="eth"
              image="https://www.americanbankingnews.com/wp-content/timthumb/timthumb.php?src=https://www.marketbeat.com/logos/cryptocurrencies/9017.png&w=240&h=240&zc=2"
              size="40px"
            />
            <NativeBalance />
            <Account />
      ...
      <Footer style={{ textAlign: "center" }}>
        ...
        <Text style={{ display: "block" }}>
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="mailto:asitminz007@gmail.com"
          >
            Mail
          </a>
        </Text>
